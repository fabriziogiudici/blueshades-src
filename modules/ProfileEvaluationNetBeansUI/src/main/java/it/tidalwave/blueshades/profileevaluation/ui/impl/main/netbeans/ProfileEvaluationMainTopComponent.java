...
@TopComponent.Description(preferredID = "ProfileEvaluationMainTopComponent", 
                          iconBase="it/tidalwave/blueshades/profileevaluation/ui/impl/main/netbeans/Evaluation.png",
                          persistenceType = PERSISTENCE_NEVER)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Tools", id = "it.tidalwave.blueshades.profileevaluation.ui.impl.main.netbeans.ProfileEvaluationMainTopComponent")
