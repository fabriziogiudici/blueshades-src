 ...
 *
 **********************************************************************************************************************/
package it.tidalwave.colorimetry.adapter.fake.impl;

import it.tidalwave.colorimetry.adapter.fake.FakeColorimeterAdapterActivator;
...
public class Installer extends ModuleActorGroupActivator
  {
    public Installer()
      {
        super(FakeColorimeterAdapterActivator.class);
      }
  }
